...
* sid => латинские буквы и цифры, не короче 1 символа
* game => число, идентификатор игры (Тут ремарочка - стоит ли поменять на gameId везде где речь об идентификаторе игры? Напишите в issue)
