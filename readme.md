...
* При прыжках и падении к вертикальной состовляющей скорости за каждый тик должна прибавляться константа 0.2
...
* При прыжке (т.е. когда от клиента отправляется ненулевой dy и это допустимый случай для прыжка), скорость по y следует делать максимально допустимой по модулю
