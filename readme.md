...
* players => массив объектов, описывающих каждого игрока. В порядке подключения к игре
    ...
    - respawn => целое число, время в тиках до респауна игрока. В случае, если status == "alive", поле не требуется
...
##### Пример сообщения от сервера

    {
        ...
        "projectiles": [
            [12.14, 10.8, -0.6, 0.1, "qwerty", "M"],
            [10.14, 11.22, -0.6, 0.1, "qwerty", "M"]
        ]
    }
