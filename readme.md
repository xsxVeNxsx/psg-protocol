...
* Столкновение с любой стенкой является абсолютно неупругим, т.е. при столкновении с вертикальной стенкой обнуляется скорость по x, при столкновении с горизонтальной - по y
...
* Каждая сеть телепортов помечается одной цифрой. Телепортов в сети может быть несколько. Если игрок зашел в телепорт, помеченный какой-то цифрой, выйти он должен из следующего телепорта, помеченного этой же цифрой, в порядке обхода
    - Из телепорта игрок выходит без потери энергии (скорость сохраняется и не обнуляется)
