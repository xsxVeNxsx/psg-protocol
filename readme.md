...
* Ошибки типа bad&lt;Property&rt;, т.е. описывающие несоответствие параметров ограничениям, имеют больший приоритет среди специфичных для запросов. *Например, в действии signin более приоритетной будет ошибка "badLogin" над "incorrect"*
